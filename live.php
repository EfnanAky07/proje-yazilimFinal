        ...
        <section class="whats-news-area pt-50 pb-20">
            <div class="container">
                <div class="row">
                        ...
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                            ...
                            <div class="whats-news-caption">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-sm-6 ">
                                        <div class="single-what-news mb-100">
                                            ...
                                            <div class="what-img ">
                                                ...
                                                <img class=" mb-5 w-100  img-fluid"
                                                    src="<?php echo $bilgilerimscek['resim'] ?>"
                                            ...
                                            <div class="what-cap ">
                                                ...
                                                <span
                                                    class="text-secondary"><?php echo $bilgilerimscek['tarih'] ?></span>
                                    ...
                                    <?php } 
                                       if($say==0){
                                        echo "<div class='alert alert-danger col-xl-12 text-center ' role='alert'>
                                          Hayat Hakkında Haber Daha Eklenmdi
                                      </div>";
                                    }?>
                    ...
                    <div class="col-lg-2 pb-5 d-none d-xl-block d-lg-block ">
