                                ...
                                <?php
                                    ...
                                    <div class="weekly2-single">
                                        ...
                                        <div class="weekly2-caption">
                                            <span
                                                class="color1 text-uppercase"><?php echo $bilgilerimscek['haberkonu'] ?></span>
        ...
        <section class="whats-news-area pt-50 pb-20">
            <div class="container">
                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-sm-6 ">
                                        <div class="single-what-news mb-100">
                                            ...
                                            <div class="what-img ">
                                                ...
                                                <img class=" mb-5 w-100  img-fluid" src="<?php echo $bilgilerimscek['resim'] ?>" style="height: 160px; object-fit: cover; "   >
                                            ...
                                            <div class="what-cap ">
                                                ...
                                                <span class="  text-secondary "> <?php echo $say ?></span>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-3 pb-5 d-none d-xl-block d-lg-block ">
